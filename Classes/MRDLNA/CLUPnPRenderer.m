...
- (void)setAVTransportURL:(NSString *)urlStr WithType:(NSString*)typeStr{
    ...
    if([typeStr isEqualToString:@"3"]){
         [action setArgumentValue:aaaaDIDL forName:@"CurrentURIMetaData"];
    }
    if([typeStr isEqualToString:@"4"]){
         [action setArgumentValue:bbbbDIDL forName:@"CurrentURIMetaData"];
    }
